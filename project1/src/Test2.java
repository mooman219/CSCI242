...
public class Test2 {
    ...
    /**
     * This class should not be instantiated. It contains static test functions.
     */
    private Test2() {
    }
     ...
     * <li>Insert a header "GREETINGS" before the paragraph. (Requires the
     * creation of a new sequence under the root.)</li>
     * <li>Create an italic style and put the sequence in it; Replace the
     * sequence with the italic style.</li>
     * </ol>
     *
     * Result:
     * <pre>
