 ...
 *
 * @author ben k steele bks@cs.rit.edu, Joseph Cumbo jwc6999@rit.edu
 */
public class Store {
    ...
    /**
     * offerPurchase offers the user a choice from the list of books found. If
     * the list is empty, the method prints the message
     ...
     * offerSearch enters an open-ended user interaction loop to let a person
     * enter search queries and possibly ask to buy a book.
     * <p>
     * </p>
     * Based on the search code entered ('t', 'a', or 'm'), the search scans the
     * inventory for values matching an entered phrase.
     * </p>
     * <p>
     * The matching process is case-insensitive. The user may enter a blank line
     * or a 'q' to quit.
     * </p>
     * <p>
     * If there are any matches, the user has the chance to choose which one to
     * buy.
     * </p>
     */
